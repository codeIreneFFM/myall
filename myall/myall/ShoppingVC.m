...
@interface ShoppingVC ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDataSource,UICollectionViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ShoppingTableViewCell *cell = (ShoppingTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(ShoppingTableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
...
{
    NSArray *collectionViewArray = [self.dataArray[[(ShoppingCollectionView *)collectionView indexPath].row]objectForKey:@"goods"];
    return collectionViewArray.count;
}

-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ShoppingCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CollectionViewCellIdentifier forIndexPath:indexPath];
    
    NSArray *collectionViewArray = [self.dataArray[[(ShoppingCollectionView *)collectionView indexPath].item]objectForKey:@"goods"];
...
{
    NSInteger section = [(ShoppingCollectionView *)collectionView indexPath].row;
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    ShoppingCollectionView *collectionView = (ShoppingCollectionView *)scrollView;
