...
@implementation ShoppingCollectionView
...
- (void)initialize
{
    ...
    self.collectionView = [[ShoppingCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
    self.collectionView.frame = CGRectMake(0, tempHeight + 10 + 50 + 5, [UIScreen mainScreen].bounds.size.width, 85 + 45);
    [self.collectionView registerClass:[ShoppingCollectionViewCell class] forCellWithReuseIdentifier:CollectionViewCellIdentifier];
